...
// Push all attributes information in an array
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $info_box_contents[$cur_row][] = array('align' => 'center',
                                             'params' => '',
                                             'text' => '<br style="line-height:1px;"><br style="line-height:21px">' . (($_SESSION["sStoreType"] == "store") ? '<span class="productSpecialPrice">'.$products[$i]['quantity'].'</span>':tep_draw_input_field('cart_quantity[]', $products[$i]['quantity'], 'size="4" class="se3"')) . tep_draw_hidden_field('products_id[]', $products[$i]['id']));
