												...
												<table cellspacing="0" cellpadding="0" border="0" class="product">
													<tr><td>
															<table cellspacing="0" cellpadding="0" border="0">
																<tr><td height="100%">
		<table cellpadding="0" cellspacing="0" border="0" align="left" class="prod_info" style="background:url(images/bg_vv.gif) right top repeat-y;">
			<tr><td align="center" style="padding:0px 40px 0px 0px;">
			
<?php echo tep_draw_prod_pic_top();?>

<script language="javascript"><!--
document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $product_info['products_id']) . '\\\')">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], addslashes($product_info['products_name']), SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, ' style="margin:15px 0px 0px 0px;"') . ''; ?>');
//--></script>
<noscript>
<?php echo '<a href="' . tep_href_link(DIR_WS_IMAGES . $product_info['products_image']) . '" target="_blank">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, ' style="margin:15px 0px 0px 0px;"') . ''; ?>
</noscript>
...
<?php echo '<div><a href="' . tep_href_link(DIR_WS_IMAGES . $product_info['products_image']) . '" target="_blank"><br style="line-height:7px">' . TEXT_CLICK_TO_ENLARGE . '</a></div>'; ?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="title_info">
			<tr><td><em><?php echo stripslashes($products_name) ?></em></td></tr>
		</table>
...
<?php
if (tep_not_null($product_info['photo_embed']) || tep_not_null($product_info['video_embed'])){
	?>
	
	<table border="0" cellpadding="10" cellspacing="0" align="center">
		
		<?php
		if (tep_not_null($product_info['photo_embed'])) echo "<tr><td style=\"vertical-align:top; text-align:center;\">".stripslashes($product_info['photo_embed'])."</td></tr>";
		if (tep_not_null($product_info['video_embed'])) echo "<tr><td style=\"vertical-align:top; text-align:center;\">".stripslashes($product_info['video_embed'])."</td></tr>";
		?>
...
<?php   tep_draw_heading_bottom_2();  ?>
				  <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin:5px 0px 5px 0px; height:19px;">
...
?>
            <tr>
              <td class="main">
					<?php
					if ($products_options_name['products_options_name'] == "Download"){
						echo 'This product is available by download only. To continue, press the "Add to Cart" button.';
					}else{
              ...
              <td class="main">
					...
					if ($products_options_name['products_options_name'] != "Download"){
						...
						echo tep_draw_hidden_field('id[' . $products_options_name['products_options_id'] . ']', 14);
					}
					?>
				</td>
            </tr>
...
<?php
		...
		<table cellpadding="0" cellspacing="0" class="box_width_cont product">
			<tr><td height="25" colspan="2"><strong><?php echo TEXT_PRODUCT_OPTIONS; ?></strong></td></tr>
			<tr>
				<td class="main">This product is available for pickup at the Hope Cybrary only. To continue, press the "Add to Cart" button.</td>
			</tr>
			<tr><td height="10" colspan="2"></td></tr>
		</table>
		<?php
...
<div id="mobile-container">
  ...
  <div id="mobile-header-container">
    ...
    <div id="mobile-header-title-container"  style="width: 45%;text-align: center;">
      <h2 id="mobile-header-title"><a href="/index.php">Product Information</a></h2>
    </div>
  ...
  $p_price = '<span class="productSpecialPrice">'.$currencies->display_price($product_info['products_price'], tep_get_tax_rate($product_info['products_tax_class_id'])).'</span>';

  ?>
  <div id="mobile-content">
    <div class="h2" style="text-align:center;"><?= $product_info['products_name'] ?></div>
    <div class="rewards-products-container">
    	<div style="width:auto%">
		    <div>
		      <?= tep_image(DIR_WS_IMAGES . $product_info['products_image'], $new_products['products_name'], SMALL_IMAGE_WIDTH + 80, SMALL_IMAGE_HEIGHT + 80) ?>
		    </div>
		    <div class="products-mobile-description-container" style="margin-top:30px">
		    ...
		    <div class="products-mobile-price-container">
		      ...
		      <div style="float: right;width: 50%;text-align: right;">
		      	<form action="/product_info.php?products_id=<?= $product_info['products_id'] ?>&action=add_product" method="POST">
		      		<input type="hidden" name="products_id" value="<?= $product_info['products_id'] ?>">
		        	<button href="<?= tep_href_link("products_new.php","action=buy_now&products_id=".$product_info['products_id']) ?>">Add to cart</button>
		      	</form>
		      </div>
		    </div>
		  </div>
