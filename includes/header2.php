 ...
 <table cellspacing=0 cellpadding=0 width=647 align=center style="width:647px;">
  ...
  <tr><td valign=top style=" border-right:8px solid #ffffff;">
   <table cellspacing=0 cellpadding=0>
    <tr><td><a href="<?php echo tep_href_link('index2.php')?>"><?php echo tep_image(DIR_WS_IMAGES.(($_SESSION["sStoreType"] == "store") ? 'm01.gif':'m01_commmissary.gif'))?></a></td>
    <td valign=top>
...
?></td></tr>
        ...
        <td class=ch2><table cellspacing=0 cellpadding=0>
          <tr>
            <td><a href="<?php echo tep_href_link('shopping_cart2.php')?>">
          ...
          <tr>
            <td colspan=2 class=ch4><?php echo tep_draw_separator('spacer.gif', '45', '1'); ?><a class=ch5 href="<?php echo tep_href_link('shopping_cart2.php')?>">
  ...
  <tr><td  width=647 height=48 valign=top style="border-right:0px solid #ffffff;background:url(images/m12.gif) left top no-repeat;">
   <table cellspacing=0 cellpadding=0>
    ...
    <td width=5></td>
    <td><a href="<?php echo tep_href_link('index2.php')?>"><?php echo tep_image_button('b01.gif')?></a></td>
    <td><a href="<?php echo tep_href_link('products_new2.php')?>"><?php echo tep_image_button('b02.gif')?></a></td>
    <td><a href="<?php echo tep_href_link('account.php')?>"><?php echo tep_image_button('b03.gif')?></a></td>
    <td><a href="<?php echo tep_href_link('shopping_cart2.php')?>"><?php echo tep_image_button('b04.gif')?></a></td>
