...
define('TABLE_HEADING_NEW_PRODUCTS', 'My Awards For %s');
define('TABLE_HEADING_UPCOMING_PRODUCTS', 'Upcoming Products');
define('TABLE_HEADING_DATE_EXPECTED', 'Date Expected');

if ( ($category_depth == 'products') || (isset($HTTP_GET_VARS['manufacturers_id'])) || isset($_GET['merchant_id']) ) {
  ...
  define('TEXT_NO_PRODUCTS', 'There is no product available for this category/merchant.');
