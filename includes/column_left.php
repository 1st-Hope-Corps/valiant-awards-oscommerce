...
*/
?>
<table border="0" cellspacing="0" cellpadding="0" class="box_width_left" style="display:none;">
	<tr><td width="100%">
...
?>
		...
		<!--<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr><td><a href="<?php echo tep_href_link('index.php?cPath=5')?>"><?php echo tep_image(DIR_WS_IMAGES.'m19-how-toclaim.png')?></a></td></tr>
		</table>-->
		
		<div style="margin-top:5px;">
			<a href="<?php echo tep_href_link('index.php?cPath=5')?>"><?php echo tep_image(DIR_WS_IMAGES.'m19-how-toclaim.png')?></a>
		</div>
