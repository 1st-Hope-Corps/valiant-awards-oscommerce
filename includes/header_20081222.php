...
<table border="0" cellspacing="0" cellpadding="0" class="Header" align="center">
	<tr>
		<td style="font-family:times; font-size:24pt; padding-left:5px; padding-bottom:20px;">MyGizmoz.com</td>
	</tr>
	<tr>
		<td>
			<table border="0" cellspacing="2" cellpadding="6">
				<tr>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com">Main</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/invite">Invite</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/profiles">My Page</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/profiles/members">Members</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/events">Events</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/forum">Forum</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/photo">Photo</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/video">Video</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/product">Products</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/store">Mall/Store</a></td>
					<td class="MenuTab" onmouseover="this.className='MenuTabOver';" onmouseout="this.className='MenuTab';"><a class="Tab" href="http://gizter.ning.com/chat">Chat</a></td>
				</tr>
			</table>
		</td>
	</tr>
