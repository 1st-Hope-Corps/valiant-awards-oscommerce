				  ...
				  <tr>
					<td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="bor">
					  <tr>
						...
						<td class="main" width="100%" valign="top"><?php echo (($_SESSION["sStoreType"] == "store") ? TEXT_CHOOSE_SHIPPING_DESTINATION_DOWNLOAD:TEXT_CHOOSE_SHIPPING_DESTINATION) . '<br><br><a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_image_button('button_change_address.gif', IMAGE_BUTTON_CHANGE_ADDRESS) . '</a>'; ?></td>
					  ...
					  <tr>
						...
						<td valign="top">
							<table border="0" cellspacing="0" cellpadding="2">
							  <tr>
								<td class="main" align="center" valign="top"><?php echo '<b>' . (($_SESSION["sStoreType"] == "store") ? TITLE_SHIPPING_ADDRESS_DOWNLOAD:TITLE_SHIPPING_ADDRESS) . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
								<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td> 
