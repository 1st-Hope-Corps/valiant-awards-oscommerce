...
<?php echo '<div><a href="' . tep_href_link(DIR_WS_IMAGES . $product_info['products_image']) . '" target="_blank"><br style="line-height:7px">' . TEXT_CLICK_TO_ENLARGE . '</a></div><br style="line-height:12px;">'; ?>
		...
		?>
						...
						<td align="right" style=" vertical-align:middle;"><a href="<?php echo tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now')?>"><?php echo tep_image_button('button_add_to_cart.gif', IMAGE_BUTTON_IN_CART)?></a><br style="line-height:1px;"><br style="line-height:11px;"></td>
					  </tr>
