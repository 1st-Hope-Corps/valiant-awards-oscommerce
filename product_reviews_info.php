...
?>
              ...
              <td height="10"><?php echo tep_draw_separator('spacer.gif', '1', '1'); ?></td>
				<td align="right" width="100%"><a href="<?php echo tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now')?>"><?php echo tep_image_button('button_add_to_cart.gif', IMAGE_BUTTON_IN_CART)?></a></td></tr>
            </table>
				<br style="line-height:1px;"><br style="line-height:10px;">
					<table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
