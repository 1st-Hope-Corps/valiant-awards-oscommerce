		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="4" cellpadding="2">
              <tr>
                <td class="main"><?php echo '<b>' . (($_SESSION["sStoreType"] == "store") ? HEADING_BILLING_ADDRESS_DOWNLOAD:HEADING_BILLING_ADDRESS) . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ($_SESSION["sStoreType"] == "store") ? $_SESSION["email_address"]:tep_address_format($order->billing['format_id'], $order->billing, 1, ' ', '<br>'); ?></td>
              </tr>
              <tr>
