...
// Push all attributes information in an array
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $info_box_contents[$cur_row][] = array('align' => 'center',
                                             'params' => '',
                                             'text' => '<br style="line-height:1px;"><br style="line-height:21px">'.tep_draw_input_field('cart_quantity[]', $products[$i]['quantity'], 'size="4" class="se3"') . tep_draw_hidden_field('products_id[]', $products[$i]['id']));

      $info_box_contents[$cur_row][] = array('align' => 'center',
                                             'params' => '',
                                             'text' => '<br style="line-height:1px;"><br style="line-height:24px"><span class="productSpecialPrice">' . $currencies->display_price($products[$i]['final_price'], tep_get_tax_rate($products[$i]['tax_class_id']), $products[$i]['quantity']) . '</span>');
    }
...
?>
											<table cellpadding="0" cellspacing="0" border="0"><tr><td style="height:3px;" class="bg_gg"><?php echo tep_draw_separator('spacer.gif', '1', '1'); ?></td></tr></table>
												<table cellspacing="0" cellpadding="0" border="0" class="shop_cart" style=" background:#009900;">
													<tr>
														<td width="75%" align="right" class="shop_cart" style="vertical-align:middle;text-align:right; height:28px;"><b><?php echo SUB_TITLE_SUB_TOTAL; ?></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
